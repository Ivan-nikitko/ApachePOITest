...
public class ExcelExporter {
    ...
    public void export(FileInputStream inputStream, FileOutputStream outputStream, String tableName, DataFrame dataFrame) {
        try {
    ...
    public void export1(String filePath, String tableName, DataFrame dataFrame) {
